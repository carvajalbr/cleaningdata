...
download.data <- function () {
  zip.url <- 'https://d396qutidysza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip'
...
load.dataset <-tidy function (set, features, labels) {
...
run.analysis <- function () {
  setwd('/Users/renecarvajal/Documents/Coursera/UCI HAR Dataset/')
